...
// Steve's Mod of Bill's Mod of Ladyada's mod :-)
// Circa 2015/08/23
...
//    Serial.println("exists.");
  ...
  // PMTK_SET_NMEA_UPDATE_1HZ = Once a second
  // PMTK_SET_NMEA_UPDATE_5HZ = 5 times a second
  // PMTK_SET_NMEA_UPDATE_10HZ = 10 times a second
  GPS.sendCommand(PMTK_SET_NMEA_UPDATE_200_MILLIHERTZ);

  // Sets the fix update rate (separate from output update rate)
  // Options are:
